...
<script src="media/admin/dictionary/basicItem/expression/js/expression.js"></script>

<div id="expression-tree">
		  <div class="tree_view_panel" expressionId="${expressionId }" sourcecode="${sourcecode }" id="tree_view_panel">

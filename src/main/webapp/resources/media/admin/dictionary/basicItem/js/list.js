        ...
        if($(this).hasClass("active")) {
        	...
        	Ajax.ajax('admin/dictionary/basicItem/getTwoLevelAttr', {
                ...
                for (var key in child) {   
                    if(child[key][2] == '0'){                    	
                    	str = str + "<div title=\"id:"+child[key][0]+", 名称："+child[key][1]+", 对应字典:"+child[key][3]+"\" twoLevel_chil_Id=" + child[key][0] +" class='entity_attr new_add_twolc newadd'>"+child[key][1]+"<i class=\"icon status\"></i><ul class='entity_ul' entityId='${item.code}' status='${item.usingState}'><li><a href='javascript:void(0)' twoId="+child[key][0]+" class='delete_twoLevelAttr_chil'><i class='icon edit-entity'></i>删除属性</a></li></ul></div>"
                    } else if(child[key][2] == '2'){                    	
                    	str = str + "<div title=\"id:"+child[key][0]+", 名称："+child[key][1]+", 对应字典:"+child[key][3]+"\" twoLevel_chil_Id=" + child[key][0] +" class='entity_attr new_add_twolc stale'>"+child[key][1]+"<i class=\"icon status\"></i><ul class='entity_ul' entityId='${item.code}' status='${item.usingState}'><li><a href='javascript:void(0)' twoId="+child[key][0]+"  class='delete_twoLevelAttr_chil'><i class='icon edit-entity'></i>删除属性</a></li></ul></div>"
                    } else if(child[key][2] == '-1'){                    	
                    	str = str + "<div title=\"id:"+child[key][0]+", 名称："+child[key][1]+", 对应字典:"+child[key][3]+"\" twoLevel_chil_Id=" + child[key][0] +" class='entity_attr new_add_twolc inerror'>"+child[key][1]+"<i class=\"icon status\"></i><ul class='entity_ul' entityId='${item.code}' status='${item.usingState}'><li><a href='javascript:void(0)' twoId="+child[key][0]+"  class='delete_twoLevelAttr_chil'><i class='icon edit-entity'></i>删除属性</a></li></ul></div>"
                    } else if(child[key][2] == '1'){                    	
                    	str = str + "<div title=\"id:"+child[key][0]+", 名称："+child[key][1]+", 对应字典:"+child[key][3]+"\" twoLevel_chil_Id=" + child[key][0] +" class='entity_attr new_add_twolc inuse'>"+child[key][1]+"<i class=\"icon status\"></i><ul class='entity_ul' entityId='${item.code}' status='${item.usingState}'><li><a href='javascript:void(0)' twoId="+child[key][0]+"  class='delete_twoLevelAttr_chil'><i class='icon edit-entity'></i>删除属性</a></li></ul></div>"
                    }
                }
